                ...
                <div class="row">
                    <div class="col-sm-4">
                        <?php if(isset($categoryName)) :?>
                            ...
                            <table class="table">
                                <tr>
                                    <th>Аудио в категориии <? echo $categoryName?></th>
                                </tr>
                        ...
                        //debug($category);
                            ...
                            <table class="table">
                                ...
                                <?php foreach ($new_cat as $val): ?>
                                    ...
                                    <tr>
                                        <td><a href="/admin/<?php echo $this->route['table']?>/category/<? echo $val?>"><?php echo htmlspecialchars($val, ENT_QUOTES); ?></a></td>
                                    </tr>
                                <?php endforeach; ?>
                            </table>
